        ...
        <table>
          <tr>
            <td style={{ width: "300px" }}>
              Base Rate (upto {singleVehicle?.baseDistance} mile(s))
            </td>
            <th className="text-end">$ {singleVehicle?.basePrice}</th>
          </tr>
          <tr>
            ...
            <th className="text-end">
              ...
              0
                ? `${
                    Math.round(totalKms) -
                    parseFloat(singleVehicle?.baseDistance)
                  } `
                : 0}{" "}
              Mile(s)
            </th>
          ...
          <tr>
            ...
            <th className="text-end">$ {TimeType == "Day" ? 0 : 20}</th>
          </tr>
          <tr>
            <td style={{ width: "300px" }}>Meet and Greet</td>
            <th className="text-end">
              $ {locations?.meetGreet === "Yes" ? 25 : 0}
            </th>
          </tr>
          <tr>
            <td style={{ width: "300px" }}>Gratuity</td>
            <th className="text-end">$ {locations?.gratuityAmount}</th>
          </tr>
          <tr>
            <td style={{ width: "300px" }}>Trip Discount</td>
            <th className="text-end">$ {locations?.discount}</th>
          </tr>
        </table>
      </div>
